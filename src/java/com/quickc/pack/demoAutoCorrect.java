...
public class demoAutoCorrect {

    private static String wordsFileName = "H:\\Shejari\\src\\words.txt"; // Word list text file
    ...
    /**
     * Searches for userWord in word list.<br> Prints "Correct." if word is
     * spelled correctly.<br> Prints a suggestion if word is close to a correct
     * word.<br> Prints "No suggestions." if word is clearly obscure.
     *
     */
