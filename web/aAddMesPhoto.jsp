                            ...
                            <div class="box box-primary">
                                <div class="box-body">
                                    <%
                                        ...
                                        if (mid != null) {
                                            session.setAttribute("mesidAdd", mid);
                                        }
                                    %>
                                    <form role="form" ENCTYPE="multipart/form-data" onsubmit="return formSubmitCheck()" action="aAddMesPhotoCheck.jsp" method="post">
                                        <div class="box-body">
                                            <div class="form-group">
                                                <label> Select Mes Photo</label>
