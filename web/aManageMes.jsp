    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-md-12" id="storeDetails">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <a href="aAddStoreLocation.jsp?type=mes" class="btn-sm btn-primary pull-right">
                                        <i class="fa fa-plus"></i> Add Mes</a>
                                </div>
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <%
                                                String mesName = "", location = "", city = "", mesStatus = "";
                                                String regDate = "", img = "";
                                                int cnt = 0, mesid = 0;
                                                ...
                                                pst = con.prepareStatement("select * from mes order by regdate desc");
                                                rs = pst.executeQuery();
                                                while (rs.next()) {
                                                    cnt++;
                                                    mesid = rs.getInt("mesid");
                                                    mesName = rs.getString("mesname");
                                                    location = rs.getString("mesarea");
                                                    city = rs.getString("city");
                                                    mesStatus = rs.getString("messtatus");
                                            ...
                                            <tr>
                                                ...
                                                %>
                                                <td class="text-blue" style="cursor: pointer"><a href="aMesDetails.jsp?mid=<%=mesid%>"><%=mesName%></a></td>
                                                <%} else {
                                                %>
                                                <td><%=mesName%></td>
                                                <%}%>                                            
                                                <td><%=location%>, <%=city%></td>
                                                <td><a href="JavaScript:changeStatus('<%=mesid%>','<%=mesStatus%>','mes')"><%=mesStatus%></a></td>
                                                ...
                                                %>
                                                <td>
                                                    <a href="JavaScript:del('<%=mesid%>','mes')" style="margin-left: 7px">
        ...
        <script>
            ...
            $("table tr").on("click","td:nth-child(5)",function () {
                var mid = $(this).siblings(":nth-child(1)").text();
                var td5 = $(this).text();
                $("#storeDetails").addClass("col-lg-8");
                $("#picPath").attr("href","aAddMesPhoto.jsp?mid="+mid);
                $(".setImage").html("<img src='images/mesphotos/"+td5+"' class='preview'>");
