...
<html>
    <head>
        ...
        <title>Add Marriage Hall Photo</title>
                            ...
                            <div class="box box-primary">
                                <div class="box-body">
                                    <%
                                        ...
                                        if (hid != null) {
                                            session.setAttribute("hallidAdd", hid);
                                        }
                                    %>
                                    <form role="form" ENCTYPE="multipart/form-data" onsubmit="return formSubmitCheck()" action="aAddHallPhotoCheck.jsp" method="post">
                                        <div class="box-body">
                                            <div class="form-group">
                                                <label> Select Marriage Hall Photo</label>
