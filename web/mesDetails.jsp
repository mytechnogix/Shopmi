            ...
            <div class="content-wrapper">
                <section class="content">
                    <div class="row">
                        ...
                        <input type="hidden" id="mesid" value="<%=objBO.getMesId()%>">
                        <div class="col-md-4">
                            <div class="box">
                                <div class="box-body">
                        ...
                        <section class="col-lg-4 connectedSortable">
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <ul class="todo-list">
                                        <%
                                            pst = con.prepareStatement("select mesname, mesid from mes where mesid!=? and messtatus='Active' order by mesname limit 10");
                                            pst.setInt(1, mesid);
                                            rs = pst.executeQuery();
                                            while (rs.next()) {
                                        %>
