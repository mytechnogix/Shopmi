...
<%
    ...
    if (session.getAttribute("oidAddOffer") != null) {
        oid = Integer.parseInt(String.valueOf(session.getAttribute("oidAddOffer")));
        try {
            ...
            if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {
                ...
                objDAO.updateOfferPhoto(objBO);
                if (objBO.isAddFlag()) {
                    session.removeAttribute("oidAddOffer");
