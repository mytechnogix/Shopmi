                            ...
                            <div class="box box-primary">
                                <div class="box-body">
                                    <div class="form-group has-feedback">
                                        <input type="email" class="form-control" id="uEmail" name="email" value="<%=aid%>" readonly="readdonly">
                                    ...
                                    <button type="submit" id="subButton" class="btn btn-primary pull-left" onclick="uChangePassCheck('admin')">Submit</button>
