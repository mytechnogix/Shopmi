                                    ...
                                    <ul class="products-list product-list-in-box">
                                        ...
                                        <li class="item">
                                            <a href="mesDetails.jsp?id=<%=rs.getString("mesid")%>" target="_blank">
                                                <div class="product-img">
                                                    <img src="images/mesphotos/<%=rs.getString("photo")%>" alt="Mes Icon">
                                                </div>
                                                <div class="product-info">
                                ...
                                <div class="box-body">
                                    <ul class="products-list product-list-in-box">
                                        <li class="item">
                                            ...
                                            <div class="product-info">
                                                <a href="#" class="product-title">Manor Mangalya
                                                </a>
                                                <span class="product-description">Dastur Nagar
                                                </span>
                                            </div>
                                        </li>
                                        <li class="item">
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <div class="info-box"  style="min-height: 50px">
                                        <span class="info-box-icon bg-aqua" style="line-height: 0px; height: auto; width: 100%">
                                            <i class="ion ion-ios-gear-outline"></i>
                                            <span style="font-size: 20px">Request a demo</span>
                                        </span>
                                    </div>
                                    <div class="info-box"  style="min-height: 50px">
                                        <span class="info-box-icon bg-aqua" style="line-height: 0px; height: auto">
                                            <i class="ion ion-ios-gear-outline"></i>
                                        </span>
                                    ...
                                    <div class="info-box"  style="min-height: 50px">
                                        <span class="info-box-icon bg-aqua" style="line-height: 0px; height: auto"><i class="ion ion-ios-gear-outline"></i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text">CPU Traffic</span>
                                            <span class="info-box-number">90<small>%</small></span>
                                        </div>
