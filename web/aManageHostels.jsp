...
<html>
    <head>
        ...
        <title>Manage Hostels/Rent Houses</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-md-12" id="hostDetails">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <a href="aAddStoreLocation.jsp?type=hostels" class="btn-sm btn-primary pull-right">
                                ...
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <%
                                                String hostName = "", rent = "", location = "", city = "", hostStatus = "";
                                                String regDate = "", img = "";
                                                int cnt = 0, hostid = 0;
                                                ...
                                                pst = con.prepareStatement("select * from hostel order by regdate desc");
                                                rs = pst.executeQuery();
                                                while (rs.next()) {
                                                    cnt++;
                                                    ...
                                                    hostStatus = rs.getString("hoststatus");
                                            ...
                                            <tr>
                                                ...
                                                %>
                                                <td class="text-blue" style="cursor: pointer"><a href="aHostelDetails.jsp?hostid=<%=hostid%>"><%=hostName%></a></td>
                                                <%} else {
                                                %>
                                                <td><%=hostName%></td>
                                                <%}%>                                            
                                                <td><%=rent%></td>
                                                <td><%=location%>, <%=city%></td>
                                                <td><a href="JavaScript:changeStatus('<%=hostid%>','<%=hostStatus%>','hostel')"><%=hostStatus%></a></td>
                                                ...
                                                %>
                                                <td>
                                                    <a href="JavaScript:del('<%=hostid%>','hostel')" style="margin-left: 7px">
        ...
        <script>
            ...
            $("table tr").on("click","td:nth-child(6)",function () {
                ...
                var td6 = $(this).text();
                $("#hostDetails").addClass("col-lg-8");
                $("#picPath").attr("href","aAddHostelPhoto.jsp?hostid="+hid);
                $(".setImage").html("<img src='images/hostelphotos/"+td6+"' class='preview'>");
