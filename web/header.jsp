        ...
        <div class="container">
            <div class="row row1">
                <ul class="largenav pull-right">
                    ...
                    <li class="upper-links"><a class="links" href="#">Contact</a></li>
                </ul>
            </div>
            <div class="row row2">
                <div class="col-sm-2">
                    <h2 style="margin:0px; color: white; font-family: forte"><a href="#" style="color: #fff"><span class="smallnav menu" onclick="openNav()">☰ MyShejari</span></a></h2>
                    <h1 style="margin:0px; color: white; font-family: forte"><a href="index.jsp" style="color: #fff"><span class="largenav">MyShejari</span></a></h1>
                </div>
                <div class="flipkart-navbar-search smallsearch col-sm-8 col-xs-11">
                    <div class="row">
                        ...
                        <input class="flipkart-navbar-input col-xs-10" type="search" placeholder="Search by Name or Category" name="searchQuery" id="searchQuery">
                        ...
                        <button class="flipkart-navbar-button col-xs-1" id="crossIcon">
