                    ...
                    <div class="row" >
                        <div class="col-md-8">
                            <div class="box box-primary">
                                <div class="box-body">
                                    <%
                                        String oid = request.getParameter("aid");
                                        if (oid != null) {
                                            session.setAttribute("aidPhoto", oid);
                                        }
                                    %>
                                    <form role="form" ENCTYPE="multipart/form-data" onsubmit="return formSubmitCheck()" action="aAddAdvPhotoCheck.jsp" method="post">
                                        <div class="box-body">
                                            <div class="form-group">
                                                <label> Select Advertise Photo</label>
