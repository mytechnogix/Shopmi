...
<html>
    <head>
        ...
        <title>Marriage Hall Login</title>
    ...
    <body class="hold-transition login-page" style="background-color: lightseagreen">
        <div class="login-box">
            ...
            <div class="login-box-body">
                <p class="title text-center" style="font-size: 20px">Marriage Hall Login</p>
                <p class="login-box-msg">Sign in to start your session</p>

                <form action="aLoginCheck.jsp" method="post">
                    <input type="hidden" name="type" value="hall">
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" name="id" placeholder="Hall ID">
